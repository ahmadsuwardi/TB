...
public class tu_list_jadwal_obat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataRef = FirebaseDatabase.getInstance().getReference().child("Data_minum_obat");
                ...
                dataRef.child(snapshot.getKey()).addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                        for (DataSnapshot snapshot2 : snapshot.getChildren()){
                            ...
                            String id = snapshot2.child("title").getValue(String.class);
                            ...
                            if(id != null || date != null || time != null) {
                                ...
                                obatAdapter = new ObatAdapter(tu_list_jadwal_obat.this, idL, waktuL);
    ...
    public void onBackPressed() {
        finish();
        Intent i = new Intent(tu_list_jadwal_obat.this, opsi_data_jadwal.class);
        startActivity(i);
    }
}
