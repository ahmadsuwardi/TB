...
public class daftar_pasien_checkup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataRef = FirebaseDatabase.getInstance().getReference().child("Data_checkup").child(ID);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            query.addChildEventListener(new ChildEventListener() {
                                ...
                                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                    ...
                                    bbL.add(bb);
                                    rpL.add(rp);
                                    pasienAdapter = new PasienAdapter(daftar_pasien_checkup.this , idL ,  urlL ,  namaL, umurL,  nopeL,  nope2L,  tanggalL,  alamatL,nipL,jkL,bbL,rpL);
    ...
    public void onBackPressed() {
        String ID = getIntent().getStringExtra("ID");
        finish();
        Intent i = new Intent(daftar_pasien_checkup.this, MenuDokter.class);
        i.putExtra("ID",ID);
        startActivity(i);
    }
}
