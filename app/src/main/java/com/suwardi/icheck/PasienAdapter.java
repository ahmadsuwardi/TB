...
public class PasienAdapter extends RecyclerView.Adapter<PasienAdapter.SearchViewHolder> {
    ...
    public PasienAdapter(Context context, ArrayList<String> idL , ArrayList<String> urlL , ArrayList<String> namaL, ArrayList<String> umurL, ArrayList<String> nopeL, ArrayList<String> nope2L, ArrayList<String> tanggalL, ArrayList<String> alamatL, ArrayList<String> nipL, ArrayList<String> jkL, ArrayList<String> bbL, ArrayList<String> rpL) {
    ...
    @NonNull
    @Override
    public PasienAdapter.SearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.viewlist_pasien, parent, false);
        return new PasienAdapter.SearchViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final PasienAdapter.SearchViewHolder holder, final int position) {
        ...
        holder.v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, list_jadwal.class);
